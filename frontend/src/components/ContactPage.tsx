...
import { FaMapMarkedAlt, FaPhoneAlt, FaEnvelope, FaClock, FaWhatsapp } from 'react-icons/fa';
  ...
  const contactDetails = [
    {
      ...
      title: 'Visit Us',
      content:
        '26, 1st Floor, Vishnu Industrial Estate, Masrani Lane, Halav Pool, Kurla (W), Mumbai – 400 070',
      link: 'https://www.google.com/maps/search/?api=1&query=Vishnu+Industrial+Estate+Kurla+Mumbai',
      iconColor: '#34A853', // Google Maps green
          ...
          >
            ...
            <div className="p-6 sm:p-8 text-center">
              <Button
                onClick={() =>
                  window.open(
                    'https://www.google.com/maps/search/?api=1&query=Vishnu+Industrial+Estate+Kurla+Mumbai',
                    '_blank'
                  )
                }
                size="lg"
